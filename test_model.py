...
class Agent:
    def setup_method(self):
        self.agent = script.Agent(30, agreeableness=1)
    ...
    def test_get_position(self):
        assert self.agent.position == 30
    
    #   - assigner un dictionnaire en tant qu'attributs
    def test_set_agent_attributes(self):
        assert self.agent.agreeableness == 1

# - Position :
class Position:
    def setup_method(self):
        self.position = script.Position(100, 34)
    ...
    def test_latitude_degrees(self):
        assert self.position.latitude_degrees == 34
    ...
    def test_latitude(self):
        ...
        assert self.position.latitude == 0.5934119456780721
...
class TestAgreeablenessGraph:
    ...
    # Remet tout à zéro après exécution des Tests
    def teardown_method(self):
        script.Zone.ZONES = []
